...
class ProfileScreen extends StatelessWidget {
        ...
        return GlassCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('الإعدادات الشاملة', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
              const SizedBox(height: 20),
              _buildSettingTile(Icons.person_outline, 'تعديل الحساب (الاسم، اليوزر، البايو)', () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (_) => const EditProfileScreen()));
              }),
              _buildSettingTile(Icons.auto_awesome, 'تفضيلات سديم (الذكاء الاصطناعي)', () {}),
  ...
  Widget _buildSettingTile(IconData icon, String title, VoidCallback onTap, {bool isDestructive = false}) {
    return ListTile(
      ...
      title: Text(title, style: TextStyle(color: isDestructive ? Colors.redAccent : Colors.white, fontSize: 16)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        elevation: 0,
        title: Text(user.username, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 20, letterSpacing: 1)),
        actions: [
          IconButton(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(user.bio, style: TextStyle(color: Colors.grey.shade300, fontSize: 14, height: 1.4))
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text('تحليل سديم AI', style: TextStyle(color: Colors.amberAccent, fontSize: 12, fontWeight: FontWeight.bold)),
                              const SizedBox(height: 4),
                              Text(
                                user.aiInterestsSummary ?? 'يبدو أنك مهتم بالتقنية والفنون البصرية وتطوير الذات.',
