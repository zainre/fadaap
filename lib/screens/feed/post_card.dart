              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: Colors.amberAccent.withOpacity(0.5), width: 1.5),
                  ),
          ...
          GestureDetector(
            ...
            child: Stack(
              ...
              children: [
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    placeholder: (context, url) => const ShimmerLoading(
                        width: double.infinity, height: 400, borderRadius: 0),
                ...
                if (widget.post.aiDescription != null &&
                    widget.post.aiDescription!.isNotEmpty)
                  Positioned(
                    bottom: 16,
                    left: 16,
                    child: ClipRRect(
